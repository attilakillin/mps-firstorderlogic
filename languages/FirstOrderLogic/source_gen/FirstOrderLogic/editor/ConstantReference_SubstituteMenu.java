...
public class ConstantReference_SubstituteMenu extends SubstituteMenuBase {
  ...
  protected List<MenuPart<SubstituteMenuItem, SubstituteMenuContext>> getParts(final SubstituteMenuContext _context) {
    ...
    result.add(new ConstraintsFilteringSubstituteMenuPartDecorator(new SMP_ReferenceScope_jmi3wo_a(), CONCEPTS.ConstantReference$fz));
  ...
  public List<SubstituteMenuItem> createMenuItems(@NotNull SubstituteMenuContext context) {
    ...
    context.getEditorMenuTrace().setDescriptor(new EditorMenuDescriptorBase("default substitute menu for ConstantReference. Generated from implicit smart reference attribute.", new SNodePointer("r:5389c23f-8d86-4868-bd96-51d0f09aae8a(FirstOrderLogic.structure)", "25955050022614534")));
    try {
  ...
  public class SMP_ReferenceScope_jmi3wo_a extends ReferenceScopeSubstituteMenuPart {
    ...
    public SMP_ReferenceScope_jmi3wo_a() {
      ...
      super((SAbstractConcept) CONCEPTS.ConstantReference$fz, LINKS.ref$3iQK);
    }
    @NotNull
    @Override
  ...
  public class SMP_Subconcepts_jmi3wo_b extends ConceptMenusPart<SubstituteMenuItem, SubstituteMenuContext> {
    protected Collection getConcepts(final SubstituteMenuContext _context) {
      return ConceptDescendantsCache.getInstance().getDirectDescendants(CONCEPTS.ConstantReference$fz);
    }
    @NotNull
    @Override
    public List<SubstituteMenuItem> createItems(SubstituteMenuContext context) {
