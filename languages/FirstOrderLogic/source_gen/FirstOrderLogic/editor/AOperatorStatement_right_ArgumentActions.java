...
public class AOperatorStatement_right_ArgumentActions {

  /*package*/ static AbstractCellAction createAction_DELETE(final SNode node) {
    return new AbstractCellAction() {
      public String getDescriptionText() {
        return "replace AOperatorStatement with left argument";
      }
      public void execute(EditorContext editorContext) {
        this.execute_internal(editorContext, node);
      }
      public void execute_internal(EditorContext editorContext, SNode node) {
        if (!(SConceptOperations.isExactly(SNodeOperations.asSConcept(SNodeOperations.getConcept(SLinkOperations.getTarget(node, LINKS.right$g53S))), SNodeOperations.asSConcept(CONCEPTS.AStatement$1q)))) {
          SLinkOperations.setTarget(node, LINKS.right$g53S, SConceptOperations.createNewNode(MetaAdapterFactory.getConcept(0x5d8a3d04c5e547e4L, 0x806d03da42a8c2cbL, 0x13ba598d20c7b07fL, "FirstOrderLogic.structure.AStatement")));
          return;
        }
        SNode replacement = SLinkOperations.getTarget(node, LINKS.left$tEgL);
