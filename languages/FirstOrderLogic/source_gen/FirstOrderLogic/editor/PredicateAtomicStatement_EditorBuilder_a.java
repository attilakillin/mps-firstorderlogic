...
/*package*/ class PredicateAtomicStatement_EditorBuilder_a extends AbstractEditorBuilder {
  ...
  private EditorCell createRefNodeList_0() {
    AbstractCellListHandler handler = new parametersListHandler_uy1rbj_c0(myNode, getEditorContext());
  ...
  private static class parametersListHandler_uy1rbj_c0 extends RefNodeListHandler {
    @NotNull
    private SNode myNode;

    public parametersListHandler_uy1rbj_c0(SNode ownerNode, EditorContext context) {
      super(context, false);
      myNode = ownerNode;
    }
    ...
    public EditorCell createEmptyCell() {
      getCellFactory().pushCellContext();
      getCellFactory().setNodeLocation(new SNodeLocation.FromParentAndLink(parametersListHandler_uy1rbj_c0.this.getNode(), LINKS.parameters$Ifhz));
      try {
