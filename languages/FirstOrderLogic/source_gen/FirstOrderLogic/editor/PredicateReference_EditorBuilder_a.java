...
/*package*/ class PredicateReference_EditorBuilder_a extends AbstractEditorBuilder {
  @NotNull
  private SNode myNode;

  public PredicateReference_EditorBuilder_a(@NotNull EditorContext context, @NotNull SNode node) {
    super(context);
    myNode = node;
  }
  ...
  private EditorCell createCollection_0() {
    ...
    editorCell.setCellId("Collection_a4pfto_a");
  ...
  private EditorCell createRefCell_0() {
    final SReferenceLink referenceLink = LINKS.predicate$FL91;
    SReferenceCellProvider provider = new SReferenceCellProvider(getNode(), referenceLink, getEditorContext()) {
      protected EditorCell createReferenceCell(final SNode targetNode) {
        ...
        }, targetNode, LINKS.predicate$FL91);
    ...
    if (editorCell.getSRole() == null) {
      ...
      editorCell.setSRole(LINKS.predicate$FL91);
    }
  ...
  private EditorCell createConstant_0() {
    ...
    editorCell.setCellId("Constant_a4pfto_b0");
  ...
  private EditorCell createRefNodeList_0() {
    AbstractCellListHandler handler = new parametersListHandler_a4pfto_c0(myNode, getEditorContext());
  ...
  private static class parametersListHandler_a4pfto_c0 extends RefNodeListHandler {
    @NotNull
    private SNode myNode;

    public parametersListHandler_a4pfto_c0(SNode ownerNode, EditorContext context) {
      super(context, false);
      myNode = ownerNode;
    }
    ...
    public EditorCell createEmptyCell() {
      getCellFactory().pushCellContext();
      getCellFactory().setNodeLocation(new SNodeLocation.FromParentAndLink(parametersListHandler_a4pfto_c0.this.getNode(), LINKS.parameters$Ifhz));
      try {
  ...
  private EditorCell createConstant_1() {
    EditorCell_Constant editorCell = new EditorCell_Constant(getEditorContext(), myNode, ")");
    editorCell.setCellId("Constant_a4pfto_d0");
    Style style = new StyleImpl();
